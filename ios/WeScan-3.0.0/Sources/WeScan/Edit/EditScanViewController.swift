...
//        }
    ...
    private func setupConstraints() {
        ...
        quadViewWidthConstraint = quadView.widthAnchor.constraint(equalToConstant: -100.0)
        quadViewHeightConstraint = quadView.heightAnchor.constraint(equalToConstant: -100.0)
...
//          }
          // Programmatically pop the current view controller
